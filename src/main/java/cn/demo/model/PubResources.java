...
public class PubResources {
	...
	public String toString() {
		return "PubResources [resource_id=" + resource_id + ", resource_name="
				+ resource_name + ", resource_type=" + resource_type
				+ ", priority=" + priority + ", resource_string="
				+ resource_string + ", resource_desc=" + resource_desc
				+ ", enabled=" + enabled + ", issys=" + issys + ", pid=" + pid
				+ "]";
	}
