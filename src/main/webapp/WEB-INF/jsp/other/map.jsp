...
<head>
	...
	<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=3zkvcWAb47g5SjSBYLG8exSs"></script>
...
<script type="text/javascript">
    ...
    var poi = new BMap.Point(114.067549,22.54758);
    map.centerAndZoom(poi, 16);
    map.enableScrollWheelZoom();

    var content = '<div style="margin:0;line-height:20px;padding:2px;">' +
                    '<img src="../img/baidu.jpg" alt="" style="float:right;zoom:1;overflow:hidden;width:100px;height:100px;margin-left:3px;"/>' +
                    '地址：深圳市市民中心地铁站<br/>电话：(010)59928888<br/>简介：嘻嘻嘻嘻嘻嘻嘻嘻嘻嘻嘻嘻嘻嘻嘻详详细细。' +
                  '</div>';
	...
	function openInfoWindow1() {
		searchInfoWindow1.open(new BMap.Point(114.067549,22.54758));
	}
	//样式2
	...
	function openInfoWindow2() {
		searchInfoWindow2.open(new BMap.Point(114.067549,22.54758));
	}
	//样式3
	...
	function openInfoWindow3() {
		searchInfoWindow3.open(new BMap.Point(114.067549,22.54758)); 
	}
	
	map.centerAndZoom(new BMap.Point(114.067549,22.54758), 12);
