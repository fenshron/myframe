...
<body>
     ...
     <table>
	    <!--  <tr><td style="text-align: right;"><label>resource_id:</label></td><td><input required="true" missingMessage="不能为空" class="easyui-textbox" id="resource_id" name="resource_id" type="text" /> </td></tr> -->
